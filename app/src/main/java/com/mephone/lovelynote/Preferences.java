...
import com.mephone.lovelynote.data.Book.BookIOException;

import com.mephone.lovelynote.data.Bookshelf;
import com.mephone.lovelynote.data.Storage;
...
public class Preferences
    ...
    protected static final String KEY_BACKUP_DIR = com.mephone.lovelynote.data.StorageAndroid.KEY_BACKUP_DIR;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(KEY_OVERRIDE_PEN_TYPE)) {
            Context context = getApplicationContext();
            com.mephone.lovelynote.pen.Hardware hw = com.mephone.lovelynote.pen.Hardware.getInstance(context);
