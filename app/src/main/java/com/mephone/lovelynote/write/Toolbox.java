...
public class Toolbox
    ...
    protected Toolbox(Context context, boolean left) {
        ...
        debugOptions = settings.getBoolean(HandwriterView.KEY_DEBUG_OPTIONS, true);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.toolbox_color_white:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0xff, 0xff, 0xff));
                break;
            case R.id.toolbox_color_silver:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0xc0, 0xc0, 0xc0));
                break;
            case R.id.toolbox_color_gray:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x80, 0x80, 0x80));
                break;
            case R.id.toolbox_color_black:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x00, 0x00, 0x00));
                break;
            case R.id.toolbox_color_red:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0xff, 0x00, 0x00));
                break;
            case R.id.toolbox_color_maroon:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x80, 0x00, 0x00));
                break;
            case R.id.toolbox_color_yellow:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0xff, 0xff, 0x00));
                break;
            case R.id.toolbox_color_olive:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x80, 0x80, 0x00));
                break;
            ...
            case R.id.toolbox_color_green:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x00, 0x80, 0x00));
                break;
            case R.id.toolbox_color_aqua:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x00, 0xff, 0xff));
                break;
            case R.id.toolbox_color_teal:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x00, 0x80, 0x80));
                break;
            case R.id.toolbox_color_blue:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x00, 0x00, 0xff));
                break;
            case R.id.toolbox_color_navy:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x00, 0x00, 0x80));
                break;
            case R.id.toolbox_color_fuchsia:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0xff, 0x00, 0xff));
                break;
            case R.id.toolbox_color_purple:
                if (listener != null)
                    listener.onToolboxColorListener(Color.argb(0xff, 0x80, 0x00, 0x80));
                break;
            default:
                if (listener != null) listener.onToolboxListener(v);
                break;
