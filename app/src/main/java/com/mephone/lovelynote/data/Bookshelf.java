...
import com.mephone.lovelynote.data.Book.BookLoadException;
import com.mephone.lovelynote.data.Book.BookSaveException;
import com.mephone.lovelynote.data.Storage.StorageIOException;
...
public class Bookshelf {
    ...
    public class BookPreview {
        ...
        public void deleteFromStorage() {
            storage.getBookDirectory(uuid).deleteAll();
        }
    }
